...
<div class="content-header page-data" data-additional="<?= $access_additional ?>" data-type="divisi" data-coa_selected="<?= $coa_selected ?>">
...
<div class="content-body mt-6">
	<div class="main-container mt-2">
		<div class="row">
			<div class="col-sm-12">
				<div class="card d-kanpus">
					<div class="card-header text-center">
						<?= $title ?>
						<br><span id="gab-kanpus"><?= lang('kantor_pusat') ?></span>
				...
				<div class="card d-gab mt-3 d-none">
					<div class="card-header text-center">
						<?= $title ?>
				...
				<div class="card mt-3">
	    			<div class="card-header text-center">
	    				<?= $title ?>
	    				<br><?= lang('sub_div') ?> <span id="cab"></span>
	    				<br><span class="bln"></span>	
    				</div>
    				<div class="card-body">
