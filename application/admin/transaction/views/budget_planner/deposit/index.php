...
<?php $this->load->view($path.'sub_menu'); ?>
	...
	<div class="main-container">
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header"><?= lang('rincian_deposito_berdasarkan_suku_bunga'); ?></div>
	    			<div class="card-body">
							...
							thead();
								...
								<tr>
									...
									foreach ($detail_tahun as $d) {
										...
										echo '<th class="text-center align-middle w-bulan" rowspan="2">Prosentase</th>';
									?>
								</tr>
								<tr>
									<?php
	...
	<div class="main-container">
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header"><?php echo '>> Rincian Segmen Deposito'; ?></div>
	    			<div class="card-body">
	    				<div class="table-responsive tab-pane fade active show" id="tbl_segment">
						<?php
						table_open('table table-bordered table-app table-hover');
							thead(); ?>
								<tr>
									...
									<th rowspan="2" width="50" class="border-none bg-white"></th>
									<th rowspan="2" class="text-center align-middle">PROSENTASE</th>
								</tr>
								<tr>
									<?php
									foreach ($detail_tahun as $d) {
							...
							tbody();
								tr();
								td(lang('data_not_found'),'','colspan="'.(2+count($detail_tahun)).'"');
						table_close();
						?>					
						</div>
	    			</div>
	...
	<div class="main-container mb-3 d-rekening-content">
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header"><?php echo '>> Jumlah Rekening (Noa) Deposito berdasar Suku Bunga (rate)'; ?></div>
	    			<div class="card-body">
							...
							thead();
								...
								<tr>
									...
									foreach ($detail_tahun as $d) {
										...
										echo '<th rowspan="2" width="50" class="border-none bg-white"></th>';
	...
	<div class="main-container mb-3 d-rekening-content">
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header"><?php echo '>> Jumlah Rekening (Noa) Segmen Deposito'; ?></div>
	    			<div class="card-body">
...
function loadData(){
    ...
    var page = base_url + 'transaction/deposit/data/';
...
function loadData2(){
    ...
    var page = base_url + 'transaction/deposit/data2/';
    page += '/'+ $('#filter_anggaran').val();
    page += '/'+ $('#filter_cabang').val();
  	xhr_ajax2 = $.ajax({
        url: page,
...
function loadData3(){
	...
	cLoader.open(lang.memuat_data + '...');
    var page = base_url + 'transaction/deposit/data3/';
    page += '/'+ $('#filter_anggaran').val();
    page += '/'+ $('#filter_cabang').val();
  	xhr_ajax4 = $.ajax({
        url: page,
        ...
        success: function(res){
            ...
            $('#tbl_segment tbody').html(res.data_segment);
...
function loadData4(){
    ...
    cLoader.open(lang.memuat_data + '...');
    var page = base_url + 'transaction/deposit/data4/';
    page += '/'+ $('#filter_anggaran').val();
    page += '/'+ $('#filter_cabang').val();
  	xhr_ajax5 = $.ajax({
        url: page,
...
function save_perubahan() {
	...
	var page = base_url + 'transaction/deposit/save_perubahan';
    page += '/'+ $('#filter_anggaran').val();
    page += '/'+ $('#filter_cabang').val();
...
$(document).on('click','.btn-export',function(){
    ...
    var classnya = ['#result1','#result2','#result3','#tbl_segment','#result4','#jum_segmen'];
    var dt = {};
    ...
    var url = base_url + 'transaction/deposit/export';
