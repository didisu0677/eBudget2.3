...
<div class="content-body m-t-column">
	...
	<div class="row">
		<div class="col-sm-12 col-12">
			<br>
			<div class="card">
	    		<div class="card-header"><?php echo lang('giro'); ?></div>
				<div class="row">
						...
						table_open('table table-bordered table-app table-hover');
							thead();
								...
								<tr>
									...
									<th style="background-color: #e64a19; color: white;min-width:200px;"><font color="#fff">Keterangan</font>
					...
					<div class="table-responsive tab-pane fade active show" id="result3">
						...
						table_open('table table-bordered table-app table-hover');
							thead();
								?>
								<tr>
									<th rowspan="2" style="background-color: #e64a19; color: white;vertical-align : middle;text-align:center;"><font color="#fff">No</font>
									<th rowspan="2" style="background-color: #e64a19; color: white; min-width:200px;vertical-align : middle;text-align:center;"><font color="#fff">Keterangan</font>
									<?php
									foreach ($detail_tahun as $d) {
										...
										echo '<th rowspan="2" class="border-none"</th>';
										echo '<th rowspan="2" style="background-color: #e64a19; color: white;min-width:80px;vertical-align : middle;text-align:center;"><font color="#fff">Jumlah Terakhir</font></th>';
										echo '<th rowspan="2" style="background-color: #e64a19; color: white;min-width:80px;vertical-align : middle;text-align:center;"><font color="#fff">Tambahan</font></th>';
									?>
								</tr>
								<tr>
									<?php
									foreach ($detail_tahun as $d) {
										echo '<th style="background-color: #e64a19; color: white;min-width:80px;"><font color="#fff">'.$d['singkatan'].'</font></th>';
									}
									?>
								</tr>	
							<?php		
