    ...
    $test = [];
       foreach ($A as $val) {
        ...
        if($val->glwnco == '1621013'){
            ...
            $remove = '<button type="button" class="btn btn-danger btn-remove" data-id="1621013_baru" title="Hapus"><i class="fa-times"></i></button>';
            ...
            $remove = '<button type="button" class="btn btn-danger btn-remove" data-id="5621011_baru" title="Hapus"><i class="fa-times"></i></button>';
            if(!$access_edit) $remove = '';
            $item .= '<td class="button">'.$remove.'</td>';
