    ...
    $test = [];
       foreach ($D as $val) {
        ...
        if($val->glwnco == '1621016'){
            $coa = $val->glwnco;
            $item .= '<tr>';
            $item .= '<td class="button"><button type="button" class="btn btn-danger btn-remove" data-id="1621016_baru" title="Hapus"><i class="fa-times"></i></button></td>';
            ...
            $item .= '</tr>';
             $item .= '<tr>';
            $item .= '<td class="button"><button type="button" class="btn btn-danger btn-remove" data-id="5621012_baru" title="Hapus"><i class="fa-times"></i></button></td>';
