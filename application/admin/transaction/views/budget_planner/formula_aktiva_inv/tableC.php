    ...
    $test = [];
       foreach ($C as $val) {
        ...
        if($val->glwnco == '1621015'){
            ...
            $remove = '<button type="button" class="btn btn-danger btn-remove" data-id="1621015_baru" title="Hapus"><i class="fa-times"></i></button>';
            ...
            $remove = '<button type="button" class="btn btn-danger btn-remove" data-id="5621015_baru" title="Hapus"><i class="fa-times"></i></button>';
            if(!$access_edit) $remove = '';
            $item .= '<td class="button">'.$remove.'</td>';
