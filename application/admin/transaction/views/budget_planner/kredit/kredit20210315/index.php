		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
	    			...
	    			<div class="card-body">
	    				<div class="table-responsive tab-pane fade active show height-window" id="result3" data-height="50">
						<?php
						table_open('table table-bordered table-app table-hover');
							thead();
								?>
								<tr>
									...
									<th rowspan="2" style="min-width:200px;vertical-align : middle;text-align:center;">Keterangan</th>
									...
									foreach ($detail_tahun as $d) {
										...
										echo '<th rowspan = "2" style="min-width:80px; vertical-align : middle;text-align:center;">Netto</th>';
										echo '<th rowspan = "2" class="border-none"</th>';
										echo '<th rowspan = "2" style="min-width:80px;vertical-align : middle;text-align:center;">'.substr(month_lang($tahun->bulan_terakhir_realisasi),0,3). ' ' . $tahun->tahun_terakhir_realisasi.'</th>';
										echo '<th rowspan = "2" style="min-width:80px;vertical-align : middle;text-align:center;">'.substr(month_lang($tahun->bulan_terakhir_realisasi -1),0,3). ' ' . $tahun->tahun_terakhir_realisasi.'</th>';
									?>
							...
							thead();
								...
								<tr>
									...
									foreach ($detail_tahun as $d) {
										...
										echo '<th rowspan="2" class="border-none"</th>';
										echo '<th rowspan="2" style="min-width:80px;vertical-align : middle;text-align:center;">Jumlah Terakhir</th>';
										echo '<th rowspan="2" style="min-width:80px;vertical-align : middle;text-align:center;">Tambahan</th>';
									?>
