	...
	function dt_cabang_nett($id,$kode_anggaran){
		$ls = get_data('tbl_m_cabang a',[
			'select' => '
				...
				b.glwnco,b.glwdes,
				ifnull(c.B_12,0) as n_B_012,
				ifnull(d.B_12,0) as b_B_012,
				e.status
			',
			'join' => [
				"tbl_m_coa b on b.glwnco = '1000000' and b.kode_anggaran = a.kode_anggaran and b.glwnco != '' type left",
				"tbl_budget_plan_neraca c on c.coa = b.glwnco and c.kode_anggaran = a.kode_anggaran and c.kode_cabang = a.kode_cabang type left",
				"tbl_budget_nett_neraca d on d.coa = b.glwnco and d.kode_anggaran = a.kode_anggaran and d.kode_cabang = a.kode_cabang type left",
				"tbl_history_to_budget_nett_neraca e on e.kode_anggaran = a.kode_anggaran and e.kode_cabang = a.kode_cabang type left"
			],
			'where' => [
