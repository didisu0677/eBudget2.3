...
class Pko_analis_kredit extends BE_Controller {
    var $controller = 'pko_analis_kredit';
    ...
    var $title = 'FUNGSI ANALIS KREDIT';
    ...
    private function export($data){
        ...
        $filename = 'fungsi_analis_kredit_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
