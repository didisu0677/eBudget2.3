...
class rko_pipeline_krd_konsumtif extends BE_Controller {
    ...
    private function export($data){
        ...
        $header[] = str_replace('$$nama','KRD. KONSUMTIF',lang('perkiraan_giro'));
        ...
        $filename = 'Pipeline_krd_konsumtif_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
