...
class Rko_pipeline_simp_berjangka extends BE_Controller {
    ...
    private function export($data){
        ...
        $header[] = str_replace('$$nama','SIMP. BERJANGKA',lang('perkiraan_giro'));
        ...
        $filename = 'Pipeline_simp_berjangka_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
