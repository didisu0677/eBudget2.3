...
class rko_pipeline_krd_produktif extends BE_Controller {
    ...
    private function export($data){
        ...
        $header[] = str_replace('$$nama','KRD. PRODUKTIF',lang('perkiraan_giro'));
        ...
        $filename = 'Pipeline_krd_produktif_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
