...
class Pko_empat extends BE_Controller {
    var $controller = 'pko_empat';
    ...
    private function export($data){
        ...
        $filename = strtolower(str_replace(' ','_',$title)).'_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
