...
class Pko_akuntansi_it extends BE_Controller {
    var $controller = 'pko_akuntansi_it';
    ...
    private function export($data){
        ...
        $filename = 'fungsi_akuntansi_dan_it_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
