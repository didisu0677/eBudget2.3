...
class Rko_pipeline_target_lainnya extends BE_Controller {
    ...
    function index() {
        ...
        $data['m_target_lainnya'] = $this->arr_m_target_lainnya;
    ...
    private function m_target_lainnya(){
    	$this->arr_m_target_lainnya = get_data('tbl_m_target_lainnya',[
    		'where' => [
    	...
    	$item = '';
    	foreach($this->arr_m_target_lainnya as $k => $v){
        ...
        if($dt_id):
            foreach ($dt_id as $k => $v) {
                ...
                $c = [
                    ...
                    'id_target_lainnya'   => $id_target_lainnya[$k],
    ...
    function data($anggaran="", $cabang="", $tipe = 'table'){
        ...
        if(post('export') == 'export'):
            ...
            $filename = 'Pipeline_target_lainnya_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
