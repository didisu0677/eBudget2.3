...
class Pko_pelayanan extends BE_Controller {
    var $controller = 'pko_pelayanan';
    ...
    private function export($data){
        ...
        $filename = 'fungsi_pelayanan_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
