...
class Pko_sdm_umum extends BE_Controller {
    var $controller = 'pko_sdm_umum';
    ...
    private function export($data){
        ...
        $filename = 'fungsi_sdm_dan_umum_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
