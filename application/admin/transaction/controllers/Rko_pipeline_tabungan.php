...
class Rko_pipeline_tabungan extends BE_Controller {
    ...
    private function export($data){
        ...
        $header[] = str_replace('$$nama','Tabungan',lang('perkiraan_giro'));
        ...
        $filename = 'Pipeline_tabungan_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
