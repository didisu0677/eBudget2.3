...
class Pko_pemasar extends BE_Controller {
    ...
    private function export($data){
        ...
        $filename = 'fungsi_pemasar_'.str_replace(' ', '_', $kode_anggaran_txt).'_'.str_replace(' ', '_', $kode_cabang_txt).'_'.date('YmdHis');
