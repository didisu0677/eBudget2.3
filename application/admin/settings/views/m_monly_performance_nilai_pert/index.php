...
<div class="content-body">
	<?php
	table_open('',true,base_url('settings/'.$controller.'/data'),'tbl_m_monly_performance_nilai_pert');
		thead();
			tr();
				...
				th(lang('bobot'),'text-center','data-content="bobot"');
				th(lang('nilai_bobot'),'text-center','data-content="nilai_bobot"');
