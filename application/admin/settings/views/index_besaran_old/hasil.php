...
<div class="content-header">
	<div class="main-container position-relative">
		...
		<div class="float-right">
			...
			?>
			<!-- <button class="btn btn-primary btn-import" href="javascript:;" > Import <span class="fa-save"></span></button> -->
		</div>
	...
	modal_body();
		form_open(base_url('settings/index_besaran/import'),'post','form-import');
			...
			<div class="form-group row">
				<label class="col-form-label col-sm-3" for="jutaan">Import</label>
				<div class="col-sm-9">
...
$(document).on('click','.btn-template',function(){
	var a = '<?=base_url()."assets/templateExcel/templateIndexBesaran.xlsx";?>';
	window.open(a);
});
...
$(document).on('click','.btn-export',function(){
	...
	let a = $("<a />", {
	  href: url,
	  download: "index_besaran_hasil-"+formatDate(new Date())+".xls"
	})
	.appendTo("body")
	.get(0)
	.click();
