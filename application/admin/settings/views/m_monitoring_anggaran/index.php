...
<div class="content-body">
	<?php
	table_open('',true,base_url('settings/m_monitoring_anggaran/data'),'tbl_m_monitoring_anggaran');
		thead();
			tr();
...
modal_open('modal-form');
	modal_body('style-select2');
		form_open(base_url('settings/m_monitoring_anggaran/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('settings/m_monitoring_anggaran/import'),'post','form-import');
			col_init(3,9);
