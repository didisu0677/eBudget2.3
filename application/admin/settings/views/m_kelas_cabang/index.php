...
<div class="content-body">
	<?php
	table_open('',true,base_url('settings/m_kelas_cabang/data'),'tbl_m_kelas_cabang');
		thead();
			tr();
...
modal_open('modal-form');
	modal_body();
		form_open(base_url('settings/m_kelas_cabang/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
			input('text',lang('kode'),'kode','required');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('settings/m_kelas_cabang/import'),'post','form-import');
			col_init(3,9);
