<div class="table-responsive data-general" data-id="<?= encode_id($id) ?>">
	<table class="table table-bordered table-app table-detail table-normal">
		...
		<tr>
			<th>File</th>
			<td><a href="<?php echo base_url('download/file/'.encode_string(dir_upload('import_budgetnett').$file)); ?>" class="btn btn-info btn-sm"><i class="fa-download"></i> <?php echo lang('unduh'); ?></a></td>
		</tr>
