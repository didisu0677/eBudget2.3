...
<div class="content-body">
	<?php
	table_open('',true,base_url('settings/import_budgetnett/data'),'tbl_history_import_budgetnett');
		thead();
			tr();
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('settings/import_budgetnett/import'),'post','form-import');
			col_init(3,9);
