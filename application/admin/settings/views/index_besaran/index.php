...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('settings/index_besaran/import_index'),'post','form-import');
			col_init(3,9);
...
$(document).on('click','.btn-export',function(){
	...
	let a = $("<a />", {
	  href: url,
	  download: "indek-besaran-"+formatDate(new Date())+".xlsx"
	})
	.appendTo("body")
	.get(0)
	.click();
...
$('.btn-act-template').on('click',function(){
	window.open(base_url+'settings/index_besaran/template/index', '_blank');
})
</script>