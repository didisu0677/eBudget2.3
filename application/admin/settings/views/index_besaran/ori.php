...
<div class="content-body">
	...
	table_open('',false);
		thead();
			tr();
				th(get_view_report(1),'','width="60" colspan="'.(count($kolom)+2).'" class="text-left"');
			tr();
...
$(document).on('click','.btn-export',function(){
	...
	let a = $("<a />", {
	  href: url,
	  download: "indek-besaran-ori-"+formatDate(new Date())+".xlsx"
	})
	.appendTo("body")
	.get(0)
	.click();
...
function getData(){
	...
	var page = base_url + 'settings/index_besaran/dataOri';
	page 	+= '/'+tahun_anggaran;
	page 	+= '/'+coa;
