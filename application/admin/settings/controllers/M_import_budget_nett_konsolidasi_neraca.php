...
class M_import_budget_nett_konsolidasi_neraca extends BE_Controller {
	var $controller 	= 'm_import_budget_nett_konsolidasi_neraca';
	...
	function data() {
        ...
        $config['where']['tbl_history_import_budget_nett_konsolidasi.page'] = 'neraca';
    ...
    function template(){
        ...
        $config[] = [
            'title'     => 'template_import_budget_nett_kanpus_syariah_neraca',
            'header'    => $arr,
            'data'      => $this->arrData
        ];
        // render($config,'json');
